...
TIMEFRAME = '1h'
SYMBOLS = ['6J']
DEFAULT_PARAMS = {'ribbon_step': 4, 'ribbon_count': 6, 'cci_period': 20, 'cci_trigger': 0.0, 'cci_extreme': 100.0, 'require_strict_stack': True, 'use_ribbon_exit': True, 'use_cci_extreme_exit': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
