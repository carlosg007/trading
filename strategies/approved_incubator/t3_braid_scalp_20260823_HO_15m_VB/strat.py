"""
t3_braid_scalp_20260823 - Version B (ML-filtered), promoted 2026-08-29.

Baseline signals from `baseline.py` (SHA-256 7947879906b65bca846ba7866963262866c49757e0eaf8b387e5399fd87aac07), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/t3_braid_scalp_20260823.py
...
TIMEFRAME = '15m'
SYMBOLS = ['HO']
DEFAULT_PARAMS = {'t3_period': 9, 't3_vfactor': 0.7, 'braid_fast': 3, 'braid_slow': 7, 'stiffness_period': 20, 'stiffness_threshold': 45.0, 'use_t3_filter': True, 'use_braid_filter': True, 'use_stiffness_filter': True, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': 3.0, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "t3_braid_scalp_20260823_baseline", _BASELINE_PATH)
