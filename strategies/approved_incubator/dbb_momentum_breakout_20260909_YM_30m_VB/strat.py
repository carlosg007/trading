...
TIMEFRAME = '30m'
SYMBOLS = ['YM']
DEFAULT_PARAMS = {'sma_window': 50, 'inner_sd': 1.5, 'outer_sd': 3.0, 'use_neutral_filter': True, 'use_outer_guard': True, 'use_baseline_exit': True, 'sl_atr_mult': 1.5, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
