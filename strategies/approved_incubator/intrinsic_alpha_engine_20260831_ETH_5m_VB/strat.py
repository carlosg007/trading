"""
intrinsic_alpha_engine_20260831 - Version B (ML-filtered), promoted 2026-09-09.

Baseline signals from `baseline.py` (SHA-256 da8f6be64e0deb00461cbc6f062643730d6b68652aab1dcfc6b3193b02b15f15), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/intrinsic_alpha_engine_20260831.py
...
TIMEFRAME = '5m'
SYMBOLS = ['ETH']
DEFAULT_PARAMS = {'delta_pct': 0.004, 'os_mult': 2.5, 'vol_mult': 1.0, 'ema_baseline_len': 20, 'volume_sma_len': 20, 'session_start_et': '09:30', 'session_end_et': '16:00', 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_volume_filter': True, 'use_session_filter': False, 'use_news_filter': False, 'sl_atr_mult': 1.5, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "intrinsic_alpha_engine_20260831_baseline", _BASELINE_PATH)
