"""
compressed_bollinger_reversion_20260901 - Version B (ML-filtered), promoted 2026-09-08.

Baseline signals from `baseline.py` (SHA-256 24614502fcf07f46ff002a31719b82cff7fa1a39d7636f87287cf5e54bfd53c0), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/compressed_bollinger_reversion_20260901.py
...
TIMEFRAME = '5m'
SYMBOLS = ['ETH']
DEFAULT_PARAMS = {'bb_len': 20, 'bb_mult': 2.0, 'rsi_thresh': 25.0, 'rsi_len': 14, 'use_regime_filter': True, 'use_alpha_trigger': True, 'use_midline_exit': True, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "compressed_bollinger_reversion_20260901_baseline", _BASELINE_PATH)
