...
TIMEFRAME = '1h'
SYMBOLS = ['6B']
DEFAULT_PARAMS = {'sma_L_len': 30, 'adx_thresh': 25.0, 'vol_sma_len': 20, 'session_start_et': '09:00', 'session_end_et': '14:30', 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_volume_filter': True, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': 3.0, 'trailing': True}
ML_THRESHOLD = 0.48
