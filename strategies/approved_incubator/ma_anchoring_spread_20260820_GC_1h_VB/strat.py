...
TIMEFRAME = '1h'
SYMBOLS = ['GC']
DEFAULT_PARAMS = {'fast_window': 30, 'slow_window': 100, 'spread_threshold': 0.01, 'exit_revert_mult': 0.5, 'use_macro_anchor': True, 'use_spread_hurdle': True, 'use_spread_expansion': True, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': 2.0, 'trailing': False}
ML_THRESHOLD = 0.48
