"""
semafor_ha_momentum_20260910 - Version B (ML-filtered), promoted 2026-09-10.

Baseline signals from `baseline.py` (SHA-256 cd01e1f79c34455036bab2b9a1a35aae529b9eb5cbbe9396cc366555cd6bd88f), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/semafor_ha_momentum_20260910.py
...
TIMEFRAME = '5m'
SYMBOLS = ['NQ']
DEFAULT_PARAMS = {'ha_period': 20, 'ha_smooth': 5, 'swing_lookback': 8, 'fast_ema': 9, 'rsi_period': 14, 'rsi_oversold': 30.0, 'rsi_overbought': 70.0, 'momentum_window': 10, 'use_macro_trend': True, 'use_midline_exit': True, 'use_rsi_zone_exit': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "semafor_ha_momentum_20260910_baseline", _BASELINE_PATH)
