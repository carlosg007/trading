...
TIMEFRAME = '30m'
SYMBOLS = ['6S']
DEFAULT_PARAMS = {'ema_fast': 50, 'keltner_len': 30, 'keltner_mult': 2.0, 'session_start_et': '09:30', 'session_end_et': '16:00', 'allowed_days': [0, 1, 2, 3, 4], 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_time_filter': False, 'use_day_filter': False, 'use_news_filter': False, 'sl_atr_mult': 4.0, 'tp_atr_mult': None, 'trailing': True}
ML_THRESHOLD = 0.48
