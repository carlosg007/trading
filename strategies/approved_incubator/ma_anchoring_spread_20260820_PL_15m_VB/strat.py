"""
ma_anchoring_spread_20260820 - Version B (ML-filtered), promoted 2026-08-29.
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/ma_anchoring_spread_20260820.py
...
TIMEFRAME = '15m'
SYMBOLS = ['PL']
DEFAULT_PARAMS = {'fast_window': 30, 'slow_window': 200, 'spread_threshold': 0.025, 'exit_revert_mult': 0.5, 'use_macro_anchor': True, 'use_spread_hurdle': True, 'use_spread_expansion': True, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': 3.0, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "ma_anchoring_spread_20260820_baseline", _BASELINE_PATH)
