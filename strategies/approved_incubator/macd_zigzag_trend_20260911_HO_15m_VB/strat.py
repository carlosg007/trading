"""
macd_zigzag_trend_20260911 - Version B (ML-filtered), promoted 2026-09-11.

Baseline signals from `baseline.py` (SHA-256 8de37658707500a739b3f74b446756be8a76fbb00eac5df59d47ebbb2df8a2ca), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/macd_zigzag_trend_20260911.py
...
TIMEFRAME = '15m'
SYMBOLS = ['HO']
DEFAULT_PARAMS = {'ema_period': 100, 'zigzag_atr_mult': 3.0, 'macd_fast': 12, 'macd_slow': 26, 'macd_signal': 9, 'require_expansion': True, 'sl_atr_mult': 2.0, 'tp_atr_mult': 4.0, 'trailing': True, 'trail_step_atr': 0.5}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "macd_zigzag_trend_20260911_baseline", _BASELINE_PATH)
