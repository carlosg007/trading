"""
dual_ema_slope_scalp_20260831 - Version B (ML-filtered), promoted 2026-09-09.
...
TIMEFRAME = '5m'
SYMBOLS = ['HO']
DEFAULT_PARAMS = {'fast_ema': 7, 'slow_ema': 17, 'htf_ema': 50, 'htf_fast_ema': 7, 'htf_slow_ema': 17, 'min_slope': 0.15, 'vol_mult': 1.0, 'volume_sma_len': 20, 'session_start_et': '09:30', 'session_end_et': '16:00', 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_volume_filter': True, 'use_session_filter': False, 'use_news_filter': False, 'sl_atr_mult': 1.0, 'tp_atr_mult': 3.0, 'trailing': False}
ML_THRESHOLD = 0.48
