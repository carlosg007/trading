"""
t3_braid_scalp_20260823 - Version B (ML-filtered), promoted 2026-09-08.
...
TIMEFRAME = '30m'
SYMBOLS = ['GC']
DEFAULT_PARAMS = {'t3_period': 5, 't3_vfactor': 0.7, 'braid_fast': 3, 'braid_slow': 7, 'stiffness_period': 20, 'stiffness_threshold': 45.0, 'use_t3_filter': True, 'use_braid_filter': True, 'use_stiffness_filter': True, 'use_news_filter': False, 'sl_atr_mult': 1.5, 'tp_atr_mult': 3.0, 'trailing': False}
ML_THRESHOLD = 0.48
