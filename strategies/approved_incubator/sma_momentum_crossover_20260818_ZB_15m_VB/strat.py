"""
sma_momentum_crossover_20260818 - Version B (ML-filtered), promoted 2026-08-29.
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/sma_momentum_crossover_20260818.py
...
TIMEFRAME = '15m'
SYMBOLS = ['ZB']
DEFAULT_PARAMS = {'fast_window': 10, 'slow_window': 30, 'macro_window': 200, 'adx_threshold': 20.0, 'use_macro_anchor': True, 'use_adx_filter': True, 'use_news_filter': False, 'sl_atr_mult': 1.5, 'tp_atr_mult': 3.0, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "sma_momentum_crossover_20260818_baseline", _BASELINE_PATH)
