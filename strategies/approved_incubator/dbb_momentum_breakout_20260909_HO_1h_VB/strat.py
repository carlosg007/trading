"""
dbb_momentum_breakout_20260909 - Version B (ML-filtered), promoted 2026-09-10.

Baseline signals from `baseline.py` (SHA-256 80b7830c3528966c36f4ad78fc875b418dcee77d1a2644db4c17d7598691b599), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/dbb_momentum_breakout_20260909.py
...
TIMEFRAME = '1h'
SYMBOLS = ['HO']
DEFAULT_PARAMS = {'sma_window': 50, 'inner_sd': 0.5, 'outer_sd': 3.0, 'use_neutral_filter': True, 'use_outer_guard': False, 'use_baseline_exit': True, 'sl_atr_mult': 1.5, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "dbb_momentum_breakout_20260909_baseline", _BASELINE_PATH)
