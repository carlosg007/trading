...
TIMEFRAME = '1h'
SYMBOLS = ['NG']
DEFAULT_PARAMS = {'rsi_fast_len': 7, 'rsi_slow_len': 28, 'pullback_window': 3, 'volume_sma_len': 20, 'volume_mult': 1.1, 'rsi_exit_long': 80.0, 'rsi_exit_short': 20.0, 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_volume_filter': True, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': 2.0, 'trailing': False}
ML_THRESHOLD = 0.48
