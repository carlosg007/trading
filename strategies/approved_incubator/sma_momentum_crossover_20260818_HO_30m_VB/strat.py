...
TIMEFRAME = '30m'
SYMBOLS = ['HO']
DEFAULT_PARAMS = {'fast_window': 10, 'slow_window': 50, 'macro_window': 200, 'adx_threshold': 20.0, 'use_macro_anchor': True, 'use_adx_filter': True, 'use_news_filter': False, 'sl_atr_mult': 1.5, 'tp_atr_mult': 2.0, 'trailing': False}
ML_THRESHOLD = 0.48
