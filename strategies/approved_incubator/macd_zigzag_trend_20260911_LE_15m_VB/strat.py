...
TIMEFRAME = '15m'
SYMBOLS = ['LE']
DEFAULT_PARAMS = {'ema_period': 200, 'zigzag_atr_mult': 4.0, 'macd_fast': 12, 'macd_slow': 26, 'macd_signal': 9, 'require_expansion': True, 'sl_atr_mult': 2.0, 'tp_atr_mult': 4.0, 'trailing': True, 'trail_step_atr': 0.5}
ML_THRESHOLD = 0.48
