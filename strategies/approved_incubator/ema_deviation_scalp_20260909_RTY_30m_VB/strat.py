...
TIMEFRAME = '30m'
SYMBOLS = ['RTY']
DEFAULT_PARAMS = {'ema_window': 30, 'deviation_atr_mult': 2.0, 'stretch_lookback': 5, 'k_period': 8, 'd_period': 3, 'smooth_k': 3, 'oversold': 20.0, 'overbought': 80.0, 'stoch_lookback': 3, 'use_stretch_filter': True, 'use_stoch_filter': True, 'use_stoch_exit': False, 'sl_atr_mult': 1.5, 'tp_atr_mult': 1.0, 'trailing': False}
ML_THRESHOLD = 0.48
