...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/ema_deviation_scalp_20260909.py
...
TIMEFRAME = '30m'
SYMBOLS = ['YM']
DEFAULT_PARAMS = {'ema_window': 10, 'deviation_atr_mult': 2.0, 'stretch_lookback': 5, 'k_period': 14, 'd_period': 3, 'smooth_k': 3, 'oversold': 20.0, 'overbought': 80.0, 'stoch_lookback': 3, 'use_stretch_filter': True, 'use_stoch_filter': True, 'use_stoch_exit': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': 1.0, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "ema_deviation_scalp_20260909_baseline", _BASELINE_PATH)
