"""
dual_ema_slope_scalp_20260831 - Version B (ML-filtered), promoted 2026-08-31.

Baseline signals from `baseline.py` (SHA-256 59723e3ceebf4501ad78c2762af0a0f61b3c29897d6729ee248b21380346f5a5), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/dual_ema_slope_scalp_20260831.py
...
TIMEFRAME = '1h'
SYMBOLS = ['RTY']
DEFAULT_PARAMS = {'fast_ema': 9, 'slow_ema': 17, 'htf_ema': 50, 'htf_fast_ema': 7, 'htf_slow_ema': 17, 'min_slope': 0.15, 'vol_mult': 1.0, 'volume_sma_len': 20, 'session_start_et': '09:30', 'session_end_et': '16:00', 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_volume_filter': True, 'use_session_filter': False, 'use_news_filter': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "dual_ema_slope_scalp_20260831_baseline", _BASELINE_PATH)
