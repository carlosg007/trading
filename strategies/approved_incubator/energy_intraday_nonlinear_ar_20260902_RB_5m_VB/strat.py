"""
energy_intraday_nonlinear_ar_20260902 - Version B (ML-filtered), promoted 2026-09-02.
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/energy_intraday_nonlinear_ar_20260902.py
...
TIMEFRAME = '5m'
SYMBOLS = ['RB']
DEFAULT_PARAMS = {'sma_L_len': 30, 'adx_thresh': 30.0, 'vol_sma_len': 20, 'session_start_et': '09:00', 'session_end_et': '14:30', 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_volume_filter': True, 'use_news_filter': False, 'sl_atr_mult': 1.5, 'tp_atr_mult': 3.0, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "energy_intraday_nonlinear_ar_20260902_baseline", _BASELINE_PATH)
