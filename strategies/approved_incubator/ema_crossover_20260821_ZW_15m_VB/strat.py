"""
ema_crossover_20260821 - Version B (ML-filtered), promoted 2026-08-29.
...
TIMEFRAME = '15m'
SYMBOLS = ['ZW']
DEFAULT_PARAMS = {'fast_period': 20, 'slow_period': 89, 'sl_atr_mult': 2.5, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
