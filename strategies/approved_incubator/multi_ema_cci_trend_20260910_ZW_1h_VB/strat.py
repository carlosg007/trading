"""
multi_ema_cci_trend_20260910 - Version B (ML-filtered), promoted 2026-09-10.

Baseline signals from `baseline.py` (SHA-256 ec7f14e2892eb32b12808a69ea4173526238711975b337c9e608416cb708a2b5), with the causal ML
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/multi_ema_cci_trend_20260910.py
...
TIMEFRAME = '1h'
SYMBOLS = ['ZW']
DEFAULT_PARAMS = {'ribbon_step': 3, 'ribbon_count': 6, 'cci_period': 14, 'cci_trigger': 0.0, 'cci_extreme': 100.0, 'require_strict_stack': True, 'use_ribbon_exit': True, 'use_cci_extreme_exit': False, 'sl_atr_mult': 2.0, 'tp_atr_mult': None, 'trailing': False}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "multi_ema_cci_trend_20260910_baseline", _BASELINE_PATH)
