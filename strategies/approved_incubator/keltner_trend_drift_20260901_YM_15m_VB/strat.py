"""
keltner_trend_drift_20260901 - Version B (ML-filtered), promoted 2026-08-31.
...
Promoted from: /home/cgrullon/src/trading/strategies/experimental/keltner_trend_drift_20260901.py
...
TIMEFRAME = '15m'
SYMBOLS = ['YM']
DEFAULT_PARAMS = {'ema_fast': 30, 'keltner_len': 20, 'keltner_mult': 2.5, 'session_start_et': '09:30', 'session_end_et': '16:00', 'allowed_days': [0, 1, 2, 3, 4], 'use_baseline_filter': True, 'use_alpha_trigger': True, 'use_time_filter': False, 'use_day_filter': False, 'use_news_filter': False, 'sl_atr_mult': 4.0, 'tp_atr_mult': None, 'trailing': True}
ML_THRESHOLD = 0.48
...
def _baseline():
    ...
    spec = importlib.util.spec_from_file_location(
        "keltner_trend_drift_20260901_baseline", _BASELINE_PATH)
